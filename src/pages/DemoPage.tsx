  ...
  const handleSummarize = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        - "summary": A brief overview of what the patient is experiencing.
        - "symptoms": An array of the main symptoms mentioned.
        - "timeline": A string describing when the symptoms started and how they have progressed.
        - "questions": An array of 3-4 specific questions the patient should ask their clinician.
        - "disclaimer": A standard medical disclaimer.
        
        Patient Input: ${selectedScenario.description}`,
      });
      ...
      if (response.text) {
        try {
          ...
          const parsedResult = JSON.parse(cleanedText) as ClinicalSummary;
